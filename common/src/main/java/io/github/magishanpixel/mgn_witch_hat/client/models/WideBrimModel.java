...
public class WideBrimModel<T extends Entity> extends EntityModel<T> {
	private final ModelPart basebody;

	public WideBrimModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition basebody = partdefinition.addOrReplaceChild("basebody", CubeListBuilder.create().texOffs(-30, 0).addBox(-15.0F, 0.0F, -15.0F, 30.0F, 0.0F, 30.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 24.5F, 0.0F, -0.1309F, 0.0F, 0.0F));
